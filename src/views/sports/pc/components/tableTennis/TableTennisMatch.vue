    ...
    <div class="col-span-2 border-x border-slate-300 bg-surface">
      ...
      <div class="grid grid-rows-3 min-h-28 px-2 py-1 gap-2">
        <div class="grid items-center" :class="{ 'grid-cols-[1fr_30px_30px_30px_30px_30px_30px]': matchTimeType == 1 }">
          ...
          <template v-if="matchTimeType == 1">
            <div class="text-center">{{ match.tabletennisData?.game1HomeScore ?? '-' }}</div>
            <div class="text-center">{{ match.tabletennisData?.game2HomeScore ?? '-' }}</div>
            <div class="text-center">{{ match.tabletennisData?.game3HomeScore ?? '-' }}</div>
            <div class="text-center">{{ match.tabletennisData?.game4HomeScore ?? '-' }}</div>
            <div class="text-center">{{ match.tabletennisData?.game5HomeScore ?? '-' }}</div>
            <div class="text-center">{{ match.tabletennisData?.homeScore ?? '-' }}</div>
          </template>
        </div>
        ...
        <div class="grid items-center" :class="{ 'grid-cols-[1fr_30px_30px_30px_30px_30px_30px]': matchTimeType == 1 }">
          ...
          <template v-if="matchTimeType == 1">
            <div class="text-center">{{ match.tabletennisData?.game1AwayScore ?? '-' }}</div>
            <div class="text-center">{{ match.tabletennisData?.game2AwayScore ?? '-' }}</div>
            <div class="text-center">{{ match.tabletennisData?.game3AwayScore ?? '-' }}</div>
            <div class="text-center">{{ match.tabletennisData?.game4AwayScore ?? '-' }}</div>
            <div class="text-center">{{ match.tabletennisData?.game5AwayScore ?? '-' }}</div>
            <div class="text-center">{{ match.tabletennisData?.awayScore ?? '-' }}</div>
          </template>
        </div>
