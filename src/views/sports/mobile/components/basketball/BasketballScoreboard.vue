  ...
  <div class="flex flex-col rounded-md bg-surface font-semibold p-3 team">
    <div class="flex justify-between items-center text-base">
      <div class="flex items-center gap-1">
        <img src="/images/sports/basketball.png" class="w-4">
    ...
    <div class="grid grid-cols-3 m-auto">
      ...
      <div class="flex flex-col items-center gap-2">
        ...
        <div class="grid grid-cols-2 gap-2 text-sm" v-if="matchStore.respSportMarketList.matchInfo.matchPeriodStartTime > 0">
          <div class="flex items-center gap-1">
