<template>
  ...
  <div class="bg-surface border border-zinc-700 rounded-lg space-y-4 mb-2 px-2 py-3">
    ...
    <div class="grid grid-cols-[100px_1fr_100px] gap-2">
...
import { NEmpty, NProgress, NTab, NTabs } from 'naive-ui';
