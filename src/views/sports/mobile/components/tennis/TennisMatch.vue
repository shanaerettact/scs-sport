  ...
  <div class="bg-surface rounded-sm p-2 ">
    ...
    <div class="flex gap-2 text-xs mt-1" v-if="matchTimeType == 1">
      ...
      <div class="flex items-center justify-center gap-0.5">
        <span class="text-center">{{ match.tennisData?.set1HomeGames ?? '-' }}</span>
        <span>:</span>
        <span class="text-center">{{ match.tennisData?.set1AwayGames ?? '-' }}</span>
      </div>

      <!-- 第2節 -->
      <div class="flex items-center justify-center gap-0.5">
        <span class="text-center">{{ match.tennisData?.set2HomeGames ?? '-' }}</span>
        <span>:</span>
        <span class="text-center">{{ match.tennisData?.set2AwayGames ?? '-' }}</span>
      </div>

      <!-- 第3節 -->
      <div class="flex items-center justify-center gap-0.5">
        <span class="text-center">{{ match.tennisData?.set3HomeGames ?? '-' }}</span>
        <span>:</span>
        <span class="text-center">{{ match.tennisData?.set3AwayGames ?? '-' }}</span>
      </div>

      <!-- 第4節 -->
      <div class="flex items-center justify-center gap-0.5">
        <span class="text-center">{{ match.tennisData?.set4HomeGames ?? '-' }}</span>
        <span>:</span>
        <span class="text-center">{{ match.tennisData?.set4AwayGames ?? '-' }}</span>
      </div>

      <!-- 第5節 -->
      <div class="flex items-center justify-center gap-0.5">
        <span class="text-center">{{ match.tennisData?.set5HomeGames ?? '-' }}</span>
        <span>:</span>
        <span class="text-center">{{ match.tennisData?.set5AwayGames ?? '-' }}</span>
      </div>

      <div class="flex items-center justify-center gap-0.5">
        <span class="text-center">{{ match.tennisData?.homeSets ?? '-' }}</span>
        <span>:</span>
        <span class="text-center">{{ match.tennisData?.awaySets ?? '-' }}</span>
      </div>
    </div>
  </div>
