...
// --- Mock user data (replace with real store/composable) ---
...
async function refreshBalance() {
  ...
  // Brief visual flash to confirm update
...
header {
  position: relative; /* needed for flash overlay */
}

/* Single spin animation for the refresh icon */
@keyframes spin-once {
